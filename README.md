...
> **このリポジトリはCor.株式会社の独自開発です。**
> Git履歴上は2026年1月18日に寺田康佑が初期実装・配布準備を行った
> VOICEVOX抑揚辞書拡張機能であり、詳細は
> [HISTORICAL_RECORD.md](./HISTORICAL_RECORD.md) を参照してください。
...
macOS ではセキュリティ警告が表示される場合があります。以下で回避できます:
